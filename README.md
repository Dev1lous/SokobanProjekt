...
## Úrovnì
Hra momentálnì obsahuje tøi pøeddefinované úrovnì. Další úrovnì lze snadno pøidat rozšíøením metody `LoadLevel()` v souboru `MainWindow.xaml.cs`. Kadá úroveò je reprezentována møíkou znakù, kde:
